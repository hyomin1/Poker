...
리액트를 통해 실시간으로 변화하고 복잡한 게임 로직을 구현해보기 위함
...
| 게임플레이 |
| :-------------------------------------------: |
| <img width="800" src="https://github.com/hyomin1/poker/assets/98298940/ae2c5cc7-230f-4692-b27b-f8321e27aa74"/>|
...
### 게임 매칭
- 게임방을 선택해서 입장하거나 무작위로 생성되어 있는 게임을 매칭
...
### 전역 상태 관리의 필요성
- 페이지 이동이 많지 않아 Redux와 같은 전역 상태 관리 라이브러리를 도입하지 않았는데 게임 안에서도 여러개의 파일들이 사용되면서 props로 값을 전달하는 것에 한계를 느낌 

### 컴포넌트의 필요성
- 나름대로 구조화를 했다고 생각했지만 불필요한 컴포넌트들도 있었고 컴포넌트가 필요했던 부분들도 존재했음
